...
<section class="about-hero" style="background: linear-gradient(135deg, rgba(0,0,57,0.75), rgba(0,0,142,0.75)), url('assets/images/banner3.jpeg') center/cover; color: #fff; padding: 5rem 1rem; text-align: center;">
  <div class="container">
    <h1 class="display-4 fw-bold mb-3"> Founder Message</h1>
...
<section class="admin-section py-5">
  <div class="container">
    <div class="text-center mb-4">
      ...
      <h2 class="section-title">Leadership and staff driving student success</h2>
      <p class="admin-intro mx-auto" style="max-width:680px;">Our leadership team reflects a shared commitment to academic achievement, pastoral care, and the development of bold, compassionate students.</p>
    </div>
    <div class="row g-4">
